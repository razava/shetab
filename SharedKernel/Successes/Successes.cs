...
public static class CreationSuccess
{
    ...
    public static readonly Success PhoneNumber = new Success("شماره موبایل با موفقیت ثبت شد.");
    public static readonly Success Satisfaction = new Success("خشنودی سنجی با موفقیت ثبت شد.");
}
