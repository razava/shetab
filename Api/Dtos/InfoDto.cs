...
namespace Api.Dtos
{
    public class InfoDto
    {
        ...
        public List<InfoChart> BarCharts { get; set; } = new List<InfoChart>();
        public List<InfoChart> PieCharts { get; set; } = new List<InfoChart>();

        public void Add(InfoDto infoDto)
        {
            Singletons.AddRange(infoDto.Singletons);
            LineCharts.AddRange(infoDto.LineCharts);
            BarCharts.AddRange(infoDto.BarCharts);
            PieCharts.AddRange(infoDto.PieCharts);
        }
    }
    ...
    {
        public List<Tuple<string, string, string>> Values { get; set; } = new List<Tuple<string, string, string>>();
        public string Title { get; set; }
        public string Icon { get; set; }
    }
